...
function Footer() {
    return (<footer className="bg-[#FAF8F4] py-10 px-6 md:px-16">
      {/* Heading */}
      ...
      <div className="flex flex-col md:flex-row justify-between items-center mt-8">
        ...
        <div className="flex space-x-4 w-full md:w-auto">
          <input type="email" placeholder="Enter your email" className="border px-4 py-2 w-full md:w-64 outline-none"/>
        ...
        <div className="flex justify-center md:justify-end space-x-4 mt-6 md:mt-0">
          <a href="#"><lucide_react_1.Instagram size={24} className="text-gray-700 hover:text-gray-900"/></a>
          <a href="#"><lucide_react_1.MessageCircle size={24} className="text-gray-700 hover:text-gray-900"/></a>
          <a href="#"><lucide_react_1.Facebook size={24} className="text-gray-700 hover:text-gray-900"/></a>
        </div>
      </div>
    </footer>);
}

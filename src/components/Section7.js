...
var _10_jpeg_1 = require("../assets/10.jpeg"); // Apni image ka path lagao
function HeroSection() {
    return (<section className="relative w-full h-screen">
      {/* Background Image */}
      <img src={_10_jpeg_1.default} alt="Toothbrushes on marble" className="absolute inset-0 w-full h-full object-cover"/>

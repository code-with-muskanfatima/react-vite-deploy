...
var _16_png_1 = require("../assets/16.png");
function Section() {
    return (<_16_png_1.default className="w-full h-screen relative flex flex-col">
      {/* Full-Screen Image (Desktop) */}
      <div className="absolute inset-0 hidden md:block">
        <img src={_16_png_1.default} alt="section no 1" className="w-full h-full object-cover"/>
